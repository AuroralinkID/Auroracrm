<?php namespace App\Http\Controllers;
	...
	class AdminPelangganController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:pelanggan','width'=>'col-sm-10','placeholder'=>'Mohon input alamat email dengan benar'];
