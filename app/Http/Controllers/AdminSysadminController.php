<?php namespace App\Http\Controllers;
	...
	class AdminSysadminController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$nomer_project = DB::table('sysadmin')->max('id') + 1;
			$nomer_project = str_pad('P-SYS#'.$nomer_project, 5, 0 , STR_PAD_LEFT);
			...
			$this->col[] = ["label"=>"Jasa","name"=>"jasa_sysadmin_id","join"=>"jasa_sysadmin,nama"];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:sysadmin','width'=>'col-sm-10','placeholder'=>'Mohon input alamat email dengan benar'];
			...
			$this->form[] = ['label'=>'Jasa Sysadmin Id','name'=>'jasa_sysadmin_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'jasa_sysadmin,nama'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:sysadmin","placeholder"=>"Mohon input alamat email dengan benar"];
			...
			//$this->form[] = ["label"=>"Jasa Sysadmin Id","name"=>"jasa_sysadmin_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"jasa_sysadmin,nama"];
			# OLD END FORM
