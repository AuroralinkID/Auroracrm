<?php namespace App\Http\Controllers;
	...
	class AdminKomputerController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		//	$this->col[] = ["label"=>"Kategori","name"=>"kategori_id","join"=>"kategori,nama"];
			...
			$sku = DB::table('komputer')->max('id') + 1;
			$sku = str_pad('SKU/PC/No.'.$sku, 5, 0 , STR_PAD_LEFT);
