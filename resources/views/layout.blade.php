...
<header id="header_wrapper">
  <div class="container">
	...
	<!--		  <li><a href="#team" class="scroll-link">Team</a></li> -->
      ...
      @if (Auth::guest())
        <li><a href="{{url('')}}/daftar"  style="background-color: #008CBA; border: none; color: white; padding: 15px; text-align: center; text-decoration: none; display: inline-block; font-size: 12px; margin: 4px 2px; border-radius: 8px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);" ><span class="fa fa-user"></span> Daftar</a></li>
        <li><a href="{{route('getLogin')}}" style="background-color: #008CBA; border: none; color: white; padding: 15px; text-align: center; text-decoration: none; display: inline-block; font-size: 12px; margin: 4px 2px; border-radius: 8px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);"><span class="fa fa-sign-in"></span> Masuk</a></li>
  @else
    {{ Auth::user()->name }}
...
<section id="Portfolio" class="content"> 
 ...
 <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="img/android_app.png" alt="#"> </div>
          <div class="item_info"> 
      ...
      <!--/Portfolio Item WebDeveloper1--> 
       ...
       <!-- Portfolio Item #WebDeveloper2-->
        ...
        <div class="portfolio_img"> <img src="img/e.png" alt="Portfolio 1"> </div>
          <div class="item_info"> 
      ...
      <!--/Portfolio Item #WebDeveloper2--> 
            ...
            <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="img/nginx.png" alt="#"> </div>
          <div class="item_info"> 
            <h4 class="project_name">#WebDeveloper</h4>
        </div>
      </div>
      <!--/Portfolio Item WebDeveloper3--> 
       ...
       <!-- Portfolio Item #WebDeveloper4-->
            <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio_img"> <img src="img/admin.png" alt="Portfolio 1"> </div>
          <div class="item_info"> 
            <h4 class="project_name">#WebDeveloper</h4>
        </div>
      </div>
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four android  isotope-item">
        <div class="portfolio_img"> <img src="img/servis.png" alt="Portfolio 1"> </div>
          <div class="item_info"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   android isotope-item">
        <div class="portfolio_img"> <img src="img/troobleshoot.png" alt="Portfolio 1"> </div>       
          <div class="item_info"> 
				<h4 class="project_name">#Servis</h4>
        </div>
        </a> </div>
      <!--/Portfolio Item #ITKonsultan--> 
            ...
            <!-- Portfolio Item #ITKonsultan-->
            <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four android  isotope-item">
        <div class="portfolio_img"> <img src="img/kabel.png" alt="Portfolio 1"> </div>
          <div class="item_info"> 
            <h4 class="project_name">#Servis</h4>
        </div>
      </div>
      ...
      <!-- Portfolio Item #ITKonsultan-->
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   android isotope-item">
        <div class="portfolio_img"> <img src="img/data.png" alt="Portfolio 1"> </div>       
          <div class="item_info"> 
				<h4 class="project_name">#Servis</h4>
        </div>
        </a> </div>
