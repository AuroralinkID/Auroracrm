...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ action('FrontController@postDaftar') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='alamat' required placeholder="Alamat"/>
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="password" class="form-control" name='password' required placeholder="Re Password"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div style="margin-bottom:10px" class='row'>
                <div class='col-xs-12'>
                    <button type="submit" class="btn btn-primary btn-block btn-flat"><i class='fa fa-sign-in' style="padding:0px 5px 0px 5px"></i>Daftar</button>
                </div>
            </div>

            <div class='row'>
                <div class='col-xs-12' align="center"><p style="padding:10px 0px 10px 0px">Sudah Mendaftar ?<a
                                href='{{route("getLogin")}}'>Login di sini</a></p></div>
            </div>
        </form>
